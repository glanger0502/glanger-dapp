...
const Staking: NextPage = () => {
    ...
    return (
        <div className="bg-hero min-h-screen flex-wrap py-2 px-[5%]">
            <NftHeader />
            {!chainStatus && connectState && <div className="absolute top-0 left-0 w-full flex bg-secondary"><div className=" mx-auto my-0 text-secondar">the current network is not Geoli Test </div></div>}
            {connectState &&
